...
class MigrationPopulation(object):
    ...
    def migrate_population(self, from_population, to_population):
        ...
        #Calll the calculate_migration_coefficients here 

        to_population.susceptible += migrated_susceptible # migrated_susceptible *(calculate_migration_coefficient of indexing from population)/total_population of from zone
                                                            
        to_population.exposed += migrated_exposed # migrated_exposed *(calculate_migration_coefficient of indexing from population)/total_population of from zone
...
class Network(object):
    ...
    def initialize(cls, zones, total_population, eta):
        ...
        for from_zone in vertices:
         ...
         # If from zone is in green state then migrate the population from it and add the migrated population in from_zone.migration_to_map with its id and
          # apart from this zone find out the other green state zones and add the  (to_population.exposed +  to_population.susceptible) population in
          # to_zone.migration_from_map
          # After calculating (from_zone.migration_to_map and to_zone.migration_to_map)
          #update the population of each zone by adding coming population from other zones and subtracting outgoing poulation
